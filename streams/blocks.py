...
class TextImg(blocks.StructBlock):
    """Cards with image and text and button(s)."""

    title = blocks.CharBlock(required=False, help_text="Add your title")
    image = ImageChooserBlock(required=True)
    rich_text = blocks.RichTextBlock(required=True)
    button_page = blocks.PageChooserBlock(required=False)
    ...
    class Meta:  # noqa
        template = "streams/text_img.html"
        icon = "placeholder"
        label = "Text Img"


class ImgText(blocks.StructBlock):
    """Cards with image and text and button(s)."""
    ...
    class Meta:  # noqa
        template = "streams/img_text.html"
        icon = "placeholder"
        label = "Img Text"
